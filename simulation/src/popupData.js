...
//    +'         </div>'
	...
	$("#tagDetail1").click(function () {
		...
		var htm=''
			...
			+' <tr>'
			+'  <td>TT 1</td>'
			+' <td>Column Top Temperature</td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>TT 2</td>'
			+' <td>Reflux tank Temperature </td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>TT 3</td>'
			+' <td>Heating Vessle Temperature</td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>FT 1</td>'
			+' <td>Cold Water Flow Transmitter</td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>FT 2</td>'
			+' <td>Product Flow Transmitter</td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>FT 3</td>'
			+' <td>Recirculating Flow Transmitter</td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>LT</td>'
			+' <td>Reflux Level Transmitter</td>'
			+'  </tr>'
			+' <tr>'
			+'  <td>PT</td>'
			+' <td>Distillation Column Pressure Transmitter</td>'
			+'  </tr>'
